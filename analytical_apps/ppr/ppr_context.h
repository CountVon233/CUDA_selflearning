...
#ifndef EXAMPLES_ANALYTICAL_APPS_PPR_PPR_CONTEXT_H_
#define EXAMPLES_ANALYTICAL_APPS_PPR_PPR_CONTEXT_H_
...
class PPRContext : public VertexDataContext<FRAG_T, double> {
  using oid_t = typename FRAG_T::oid_t;
  using vid_t = typename FRAG_T::vid_t;

 public:
  explicit PPRContext(const FRAG_T& fragment)
      : VertexDataContext<FRAG_T, double>(fragment, true),
        result(this->data()) {}

  void Init(BatchShuffleMessageManager& messages, double delta, int max_round, oid_t source_id) {
